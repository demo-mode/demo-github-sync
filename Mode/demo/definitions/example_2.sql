SELECT *,
    ...
    FROM (
    SELECT 
REPLACE(REPLACE(REPLACE(REPLACE(r.name, 'Midwest', 'Events'),'West', 'Commercial_Business'),'Northeast', 'City_Municipalities'),'Southeast', 'Recurring_Monthly_User') AS "Parking Type",
